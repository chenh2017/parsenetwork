...
- **from**: center nodes.
- **to**: collected nodes.
- **weight**: the weight of the collection. eg. cosine similarity.
...
- **id**: The unique key. (eg. C0002716)
- **term**: Description/Term/String of the ID. Only one term for ID. (eg. amyloids)
- **semantic_type**: semantic type. (eg. Biologically Active Substance)
- **group1**: eg.  "PROC"   "CHEM"   "DISO"   "PHYS"   "PHEN"   "ACTI"
- **group2**: eg. "Ignore_cui" "Procedure"  "Disease"    "Drug"       "Lab"
- **category**: User specified group name. eg. 
...
- **id**: The unique key. (eg. PheCode:008)
- **term**: Description/Term/String of the ID. (eg. intestinal infection)
- **semantic type**: semantic type/group. (eg. infectious diseases)
- **group1**: eg. "CCS" "PheCode" "RxNorm" "Lab"
- **group2**: eg.  "Procedure"  "Disease"    "Drug"       "Lab"
- **category**: eg. "Procedure Codified"  "Disease Codified"    "Drug Codified"       "Lab Codified"
- **level1~4**:	The descriptions for hierarchical levels of `id` column. eg. The hierarchy of PheCode:008.51:   
...
- **id**: center nodes' ID. (eg. C3205666)
...
| --------------- | ------------------------------- | ---------------------- | ----------------------------- | -------------- |
| center nodes ID | The cuis rollup to center nodes |                        |                               |                |
...
- **id**: center nodes' ID. (eg. LOINC:8122-4)
- **...**: optional columns.
